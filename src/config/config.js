...
const config = {
  // API Configuration
  API_BASE_URL: import.meta.env.VITE_API_BASE_URL || 'https://handicarft-backend.onrender.com',
  BACKEND_URL: import.meta.env.VITE_BACKEND_URL || 'https://handicarft-backend.onrender.com',
